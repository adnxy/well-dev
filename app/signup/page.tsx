...
const Signup = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#151f2a" }}
    >
      {" "}
      {/* Updated background color */}
      <div className="p-10 bg-white rounded-lg shadow-xl w-full max-w-md border-gray-300">
        {" "}
        ...
        <form className="space-y-6" onSubmit={handleSignup}>
          ...
          <button
            type="submit"
            className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-lg font-medium text-white bg-emerald-500  hover:bg-emerald-600  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            Sign Up
          </button>
        </form>
