  ...
  return (
    <div className="mt-8">
      <div className="flex items-center justify-center flex-col">
        ...
        <label
          htmlFor="resume"
          className={`flex justify-center py-2.5 px-2.5 border border-transparent rounded-md shadow-sm text-lg font-medium text-white  bg-emerald-600  hover:bg-emerald-500  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#40A578] transition duration-150 ease-in-out cursor-pointer mb-2 ${resumeFile ? 'w-auto max-w-full' : 'w-64'}`}
        >
